...
import json
from myapp.models import User, Area, MountainPass
from myapp.serializers import UserSerializer, AreaSerializer, MountainPassSerializer
...
def mountain_get(request, mountain_pass_id):
